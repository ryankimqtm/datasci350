...
\caption{Creating a new Jupyter Notebook in VS Code.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{images/vscode-output.png}
\caption{The output of a code cell.}
\end{figure}
...
\caption{A text cell before and after running it.}
\end{figure}
...
\caption{A Markdown table rendered in a Jupyter Notebook.}
\end{figure}
...
\caption{The same method with custom headers and number formatting.}
\end{figure}
