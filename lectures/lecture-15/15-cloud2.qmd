...
- Click on the link provided in the terminal (it will be something like `http://localhost:8888/?token=...`)
- You can also open your browser and go to `http://localhost:8000`, and copy the token from the terminal to log in (it does not work without the token)
