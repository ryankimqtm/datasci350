...
subtitle: Lecture 10 - Reproducible Research with Quarto
author:
  - name: Danilo Freire
...
format:
  clean-revealjs:
    self-contained: true
    footer: "[Reproducible Research](https://raw.githack.com/danilofreire/datasci350/main/lectures/lecture-10/10-quarto.html)"
transition: slide
...
[![](figures/ioannidis.png){width="60%"}](#){data-modal-type="image" data-modal-url="figures/ioannidis.png"}
...
:::{style="margin-top: 30px; text-align: center; font-size: 16px;"}
[![](figures/science.png){width="60%"}](#){data-modal-type="image" data-modal-url="figures/science.png"}
...
[![](figures/sdata.png){width="40%"}](#){data-modal-type="image" data-modal-url="figures/sdata.png"}
...
[![](figures/latex.png){width="80%"}](#){data-modal-type="image" data-modal-url="figures/latex.png"}

Source: <https://github.com/danilofreire/quarto-templates/blob/main/article/article-template.latex>
:::
:::
:::
:::
...
:::{.column width="50%"}
:::{style="text-align: center; margin-top: 20px;"}
[![](figures/quarto.png){width="80%"}](#){data-modal-type="image" data-modal-url="figures/quarto.png"}
...
:::{style="margin-top: 30px; font-size: 22px; text-align: center;"}
[![](figures/report.png){width="35%"}](#){data-modal-type="image" data-modal-url="figures/report.png"}
:::
...
:::{style="margin-top: 30px; font-size: 22px; text-align: center;"}
[![](figures/dashboard.png){width="70%"}](#){data-modal-type="image" data-modal-url="figures/dashboard.png"}
...
:::{style="margin-top: 30px; font-size: 22px; text-align: center;"}
[![](figures/book-2.png){width="80%"}](#){data-modal-type="image" data-modal-url="figures/book-2.png"}  
:::
...
:::{style="margin-top: 30px; font-size: 22px; text-align: center;"}
[![](figures/website.png){width="80%"}](#){data-modal-type="image" data-modal-url="figures/website.png"}
:::
...
:::{style="margin-top: 30px; font-size: 22px; text-align: center;"}
[![](figures/quarto-download.png){width="80%"}](#){data-modal-type="image" data-modal-url="figures/quarto-download.png"}
...
[![](figures/quarto-homebrew.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/quarto-homebrew.png"}
:::
...
[![](figures/quarto-wsl.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/quarto-wsl.png"}
...
[![](figures/editors.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/editors.png"}
...
[![](figures/quarto-project-default.png){width="80%"}](#){data-modal-type="image" data-modal-url="figures/quarto-project-default.png"}
:::
...
[![](figures/quarto-project-website.png){width="80%"}](#){data-modal-type="image" data-modal-url="figures/quarto-project-website.png"}
:::
...
[![](figures/quarto-project-blog.png){width="80%"}](#){data-modal-type="image" data-modal-url="figures/quarto-project-blog.png"}
:::
...
[![](figures/quarto-project-book.png){width="80%"}](#){data-modal-type="image" data-modal-url="figures/quarto-project-book.png"}
:::
...
[![](figures/quarto-project-manuscript.png){width="80%"}](#){data-modal-type="image" data-modal-url="figures/quarto-project-manuscript.png"}
:::
...
:::{.column width="50%"}
:::{style="text-align: center;"}
[![](figures/knitr-plot.png){width="90%"}](#){data-modal-type="image" data-modal-url="figures/knitr-plot.png"}
:::
:::
:::
:::
...
:::{.column width="50%"}
:::{style="text-align: center;"}
[![](figures/jupyter-plot.png){width="90%"}](#){data-modal-type="image" data-modal-url="figures/jupyter-plot.png"}
:::
:::
:::
:::
...
:::{style="margin-top: 30px; font-size: 24px;"}
[![](figures/editor222.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/editor222.png"}
...
[![](figures/side-plots.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/side-plots.png"}
:::
