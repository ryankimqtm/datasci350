...
:::{style="margin-top: 30px; font-size: 20px; text-align: center;"}
[![](figures/docker-build.png){width="90%"}](#){data-modal-type="image" data-modal-url="figures/docker-build.png"}
:::

## Looks pretty good! 👍

:::{style="margin-top: 30px; font-size: 20px; text-align: center;"}
[![](figures/docker-build02.png){width="90%"}](#){data-modal-type="image" data-modal-url="figures/docker-build02.png"}
:::

## Looks pretty good! 👍

:::{style="margin-top: 30px; font-size: 20px; text-align: center;"}
[![](figures/docker-build03.png){width="90%"}](#){data-modal-type="image" data-modal-url="figures/docker-build03.png"}
:::
...
[![](figures/docker-hub-image.png){width="90%"}](#){data-modal-type="image" data-modal-url="figures/docker-hub-image.png"}
:::
