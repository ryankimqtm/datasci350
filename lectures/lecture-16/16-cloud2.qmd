...
subtitle: Lecture 16 - Cloud Computing II
author:
  - name: Danilo Freire
...
format:
  clean-revealjs:
    self-contained: true
    code-overflow: wrap
    footer: "[Cloud Computing II](https://raw.githack.com/danilofreire/datasci350/main/lectures/lecture-16/16-cloud2.html)"
transition: slide
...
:::{.column width="50%"}
:::{style="text-align: center;"}
[![](figures/meme.png){width="80%"}](#){data-modal-type="image" data-modal-url="figures/meme.png"}
:::
:::
:::
:::
...
[![](figures/instance-type.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/instance-type.png"}
...
[![](figures/key-pair.png){width="90%"}](#){data-modal-type="image" data-modal-url="figures/key-pair.png"}
:::
:::
:::
:::
...
- The free tier gives you [30 GB of storage]{.alert}, but 8 GB is usually enough for testing and learning purposes
...
:::{style="text-align: center;"}
[![](figures/launch.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/launch.png"}
:::
:::
:::
:::
...
:::{style="text-align: center;"}
[![](figures/ssh.png){width="80%"}](#){data-modal-type="image" data-modal-url="figures/ssh.png"}
:::
:::
:::
:::
...
[![](figures/ssh-connection.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/ssh-connection.png"}
:::
...
:::{.column width="70%"}
:::{style="text-align: center;"}
[![](figures/instance-details.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/instance-details.png"}
:::
:::
:::
:::
...
:::{.column width="50%"}
:::{style="text-align: center;"}
[![](figures/cloudshell.png){width="70%"}](#){data-modal-type="image" data-modal-url="figures/cloudshell.png"}
:::
:::
:::
:::
...
:::{.column width="60%"}
- Open a [new bash/zsh local terminal (**not the one you are using to connect to your instance!**)]{.alert} and type the following (one line at a time):
...
- [Don't forget to replace `XXXXXX` with your public IP]{.alert} and note that [`:~` is your home directory on the instance. Don't forget to add it!]{.alert}
...
:::{style="text-align: center;"}
[![](figures/hello.png){width="70%"}](#){data-modal-type="image" data-modal-url="figures/hello.png"}
::: 
:::
:::
:::
...
:::{.column width="60%"}
:::{style="text-align: center;"}
[![](figures/stop.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/stop.png"}
[![](figures/terminated.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/terminated.png"}
:::
:::
:::
:::
...
:::{style="text-align: center; margin-top: 30px;"} 
[![](figures/jupyter.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/jupyter.png"}
:::
...
- **Method 1: local to cloud with `scp`.** On your [local machine]{.alert}, create a weather dataset with the Python code below, or download it here: [weather_data.py](https://github.com/danilofreire/datasci350/blob/main/lectures/lecture-15/weather_data.py)
