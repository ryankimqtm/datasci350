...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{images/duckdb-ui.png}
\caption{The DuckDB browser interface, running one of this tutorial's queries against the World Bank data. Attached databases and their tables appear on the left.}
\end{figure}
