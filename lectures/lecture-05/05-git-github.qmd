...
[![](figures/regex.png){width="80%"}](#){data-modal-type="image" data-modal-url="figures/regex.png"}
[![](figures/regex.webp){width="80%"}](#){data-modal-type="image" data-modal-url="figures/regex.webp"}
:::
:::
:::
:::
...
[![](figures/google.png){width="35%"}](#){data-modal-type="image" data-modal-url="figures/google.png"}

[RSVP here](https://forms.office.com/Pages/ResponsePage.aspx?id=nPsE4KSwT0K80DImBtXfOGf5iP0NIbROsdVBvVq1metUNTVaSUJYMkI4QkowR1NBWUtEV1k4NFMzVSQlQCN0PWcu)
:::
...
:::{.column size="50%"}
:::{style="text-align: center;"}
[![](figures/rproject-setup.png){width="300"}](#){data-modal-type="image" data-modal-url="figures/rproject-setup.png"}
:::
:::
:::
:::
...
[![](http://phdcomics.com/comics/archive/phd101212s.gif){width="40%"}](#){data-modal-type="image" data-modal-url="http://phdcomics.com/comics/archive/phd101212s.gif"}
:::
...
- [I'm a big fan of GitHub!]{.alert} [My website](https://danilofreire.github.io/) and, as you know, [this course](https://danilofreire.github.io/datasci350) are hosted on there
:::
...
:::{.columns}
:::{.column size="50%"}
- [Repositories]{.alert} are [timelines of the entire project]{.alert}, including all changes made previously
- [Directories]{.alert}, or ‘working directories’ are projects at their [current state in time]{.alert}
...
2. Let's add a `01-data-cleaning.py` file to the `staging area`. Then, check its status
