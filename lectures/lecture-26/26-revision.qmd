...
format:
  clean-revealjs:
    self-contained: true
    code-overflow: wrap
    footer: "[Course Revision](https://raw.githack.com/danilofreire/datasci350/main/lectures/lecture-26/26-revision.html)"
transition: slide
...
:::{.columns}
:::{.column width="50%"}
- We covered [a lot of content]{.alert} this semester! 🤓
...
:::{.column width="50%"}
  * [SQL & Relational Databases]{.alert}: structured data storage and querying with SQL
