...
{{< fa globe >}} <https://danilofreire.github.io/datasci350>

{{< fa brands github >}} <https://github.com/danilofreire/datasci350>
:::

::: {.column}
:::{style="font-size: 28px;"}
- [Instructor]{.alert}: Danilo Freire
- [Lectures]{.alert}: Tuesdays and Thursdays, 5:30-6:45 pm, Math & Science Center W301
- [Office hours]{.alert}: By appointment, just send me an email in advance
- Please remember to [check the course repository regularly](https://github.com/danilofreire/datasci350) for updates and announcements 😉
:::
:::
:::
:::
...
::: {.column}
- [A terminal]{.alert}
  - Windows: install [WSL](https://learn.microsoft.com/en-us/windows/wsl/install), or use [VS Code's](https://code.visualstudio.com/) built-in terminal
...
- They are [tiny and cheap]{.alert}. A modern chip holds 200 billion and performs billions of operations per second!
