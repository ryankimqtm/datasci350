...
format:
  clean-revealjs:
    self-contained: true
    code-overflow: wrap
    footer: "[Introduction to SQL](https://raw.githack.com/danilofreire/datasci350/main/lectures/lecture-17/17-introduction-sql.html)"
transition: slide
...
- The project is due on [April 27, 2026]{.alert}
- Groups of 4-5 students
- Please send me a list with the names and emails of the group members by [next Monday]{.alert} if possible
- If you don't have a group, no problem! We'll [randomly assign you to one next week]{.alert}
...
[![](figures/view-table.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/view-table.png"}
:::
...
:::{style="margin-top: 50px; font-size: 22px; text-align: center;"}
[![](figures/added-values.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/added-values.png"}
:::
...
[![](figures/add-column.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/add-column.png"}

- Drop a column: `ALTER TABLE students DROP COLUMN major;`

[![](figures/drop-column.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/drop-column.png"}
:::
...
[![](figures/delete-row.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/delete-row.png"}
:::
:::
:::
...
[![](figures/select-columns.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/select-columns.png"}
:::
...
[![](figures/where-german.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/where-german.png"}
:::
:::
:::
...
[![](figures/or-conditions.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/or-conditions.png"}
:::
...
[![](figures/and-conditions.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/and-conditions.png"}
:::
:::
:::
...
[![](figures/aggregate.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/aggregate.png"}
:::
...
[![](figures/order-asc.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/order-asc.png"}
:::
:::
:::
...
[![](figures/groupby.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/groupby.png"}
:::
...
[![](figures/round.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/round.png"}
:::
:::
:::
...
:::{.column width="50%"}
[![](figures/export-import.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/export-import.png"}
:::
:::
:::
...
:::{.columns}
:::{.column width="50%"}
[![](figures/app02-01.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/app02-01.png"}
:::

:::{.column width="50%"}
[![](figures/app02-02.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/app02-02.png"}
:::
:::
