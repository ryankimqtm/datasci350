...
:::{.column width="50%"}
After the quiz, [lecture 14]{.alert} keeps the model and changes the interface. Ollama has been running a small web server on `localhost:11434` this whole time, and Python can talk to it. We add coding agents in your terminal, and hosted models through an API key.
