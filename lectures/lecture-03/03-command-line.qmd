...
- 8-bit colour uses 256 levels per channel, allowing for over [16 million possible colours]{.alert}
...
::: {.column width="50%"}
[![](figures/kernel-and-user-space.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/kernel-and-user-space.png"}
Source: [Dave Kerr](https://effective-shell.com/part-2-core-skills/what-is-a-shell/)
:::
...
- The [user space]{.alert} provides an interface for users, who can run
  programs/applications on the machine. Hardware access of programs (e.g., memory usage) is managed by the kernel. [Programs in user space are essentially in sandboxes]{.alert}, which sets a limit to how much damage they can do
:::
:::
:::
...
Source: [Dave Kerr](https://effective-shell.com/part-2-core-skills/what-is-a-shell/)/[Kkchaudhary11](https://commons.wikimedia.org/w/index.php?curid=49069244)
:::
...
:::{.columns}
:::{.column width="50%"}
[![](figures/diagram3-terminal-and-shell.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/diagram3-terminal-and-shell.png"}
Source: [Dave Kerr](https://effective-shell.com/part-2-core-skills/what-is-a-shell/)
:::
...
- A terminal is just a program that [reads input]{.alert} from the keyboard, [passes that input]{.alert} to another program, and [displays the results]{.alert} on the screen
...
- When you want to work with a computer in a data center (or remotely in cloud computing), you'll still do pretty much the same (but with a screen and keyboard 😉)
:::
:::
:::
...
:::{.column width="50%"}
- Terminals are really quite simple - they're just [text-based interfaces]{.alert}
...
- [Back to the shell:]{.alert} the shell usually takes input
  ...
  - Executes [scripts]{.alert} (without command line)
...
[![](figures/chtsh.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/chtsh.png"}
:::
...
::: {.column width="50%"}
[![](figures/expanding-brain.jpg){width="70%"}](#){data-modal-type="image" data-modal-url="figures/expanding-brain.jpg"}
:::
:::
:::
