...
:::{.columns}
:::{.column width=55%}
- Here's something you (hopefully) already know: [Computers only understand numbers]{.alert} (remember [lecture 02?](https://danilofreire.github.io/datasci350/lectures/lecture-02/02-computational-literacy.html))
