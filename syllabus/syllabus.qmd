...
- Lecture 08: [Review session for Quiz 01](https://danilofreire.github.io/datasci350/lectures/lecture-08/08-review.html). This session covers Lectures 01-07 (Introduction, Computational Literacy, CLI, Git/GitHub) and prepares students for Quiz 01 on September 24.

## Module 03: Literate Programming with Markdown, Quarto, and Jupyter

### September 24, 2026:

- Lecture 09: [Quiz 01: Git and Github (6%)](https://github.com/danilofreire/datasci350-quiz01/).
- **Assignment 03 due (5%).**
...
- Lecture 10: [Introduction to Quarto](https://danilofreire.github.io/datasci350/lectures/lecture-10/10-quarto.html).
...
- Lecture 11: [Writing Documents, Presentations, and Websites with Quarto](https://danilofreire.github.io/datasci350/lectures/lecture-11/11-more-quarto.html).
- **Assignment 04 due (5%).**
...
- Lecture 12: [AI and Prompt Engineering](https://danilofreire.github.io/datasci350/lectures/lecture-12/12-ai-programming.html).
...
- Yao, S., et al. (2022). [ReAct: Synergizing reasoning and acting](https://arxiv.org/abs/2210.03629).
- Anthropic (2025). [Prompt engineering overview](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering). 
- OpenAI (2025). [Prompt engineering](https://platform.openai.com/docs/guides/prompt-engineering).
- Google (2025). [Gemini Prompting Guide](https://services.google.com/fh/files/misc/gemini-for-google-workspace-prompting-guide-101.pdf). 

### October 8, 2026:

- Lecture 13: [Quiz 02: Literate Programming (6%)](https://github.com/danilofreire/datasci350-quiz02/).
- **Assignment 05 due (5%).**
...
- Lecture 14: [AI-Assisted Programming, APIs, and Agents](https://danilofreire.github.io/datasci350/lectures/lecture-14/14-ai.html).
...
- Lecture 15: [Introduction to Cloud Computing](https://danilofreire.github.io/datasci350/lectures/lecture-15/15-cloud.html).
- **Assignment 06 due (5%).**
...
- Lecture 16: [More Cloud Computing with Amazon Web Services (AWS)](https://danilofreire.github.io/datasci350/lectures/lecture-16/16-cloud2.html).
...
- Lecture 17: [Introduction to SQL: Data Types, Tables, and Queries](https://danilofreire.github.io/datasci350/lectures/lecture-17/17-introduction-sql.html).
- **Assignment 07 due (5%).**
...
- Lecture 18: [SQL in Python: Connecting to Databases with Pandas](https://danilofreire.github.io/datasci350/lectures/lecture-18/18-sql-python.html).
...
- Lecture 19: [Merging Tables in SQL](https://danilofreire.github.io/datasci350/lectures/lecture-19/19-sql-tables.html).
...
- Lecture 20: [Quiz 03: AI-Assisted Programming and Cloud Computing (6%)](https://github.com/danilofreire/datasci350-quiz03/).
...
- Lecture 21: [Parallel Computing with Dask](https://danilofreire.github.io/datasci350/lectures/lecture-21/21-parallel-computing.html).
- **Assignment 08 due (5%).**
...
- Lecture 22: [Application: Parallelising Data Analysis with Dask and AutoML](https://danilofreire.github.io/datasci350/lectures/lecture-22/22-parallel-automl.html).
...
- Lecture 24: [Quiz 04: SQL Databases (6%)](https://github.com/danilofreire/datasci350-quiz04/).
- **Assignment 09 due (5%).**
...
- Lecture 26: [Course Review](https://danilofreire.github.io/datasci350/lectures/lecture-26/26-revision.html).
...
- Lecture 27: [Quiz 05: Dask, Docker and Containers (6%)](https://github.com/danilofreire/datasci350-quiz05/).
