...
subtitle: Lecture 11 - More Quarto
author:
  - name: Danilo Freire
...
format:
  clean-revealjs:
    self-contained: true
    footer: "[More Quarto](https://raw.githack.com/danilofreire/datasci350/main/lectures/lecture-11/11-more-quarto.html)"
transition: slide
...
:::{.columns}
:::{.column width="50%"}
- [Literate programming]{.alert} is a paradigm introduced by Donald Knuth in 1984
...
- [Quarto](https://quarto.org/) allows us to easily write documents that mix code and text
...
- Blockquotes: `> quote`
- Horizontal rules: `---`
- Line breaks: `Line 1  ` (two spaces at the end)
- Footnotes: `[^1]`
- Superscript: `2^10^`
- Subscript: `H~2~O`
- In-line maths: `$\LaTeX$`
- For equations, use `$$` to create a new line, write the equation in LaTeX, and end with `$$`
...
- If you want to permanently set the path, add the line below to your `.bashrc` or `.zshrc` file (it depends on your shell)
...
:::{.columns}
:::{.column width="30%"}
- [You just have to add a YAML header to your notebook!](https://quarto.org/docs/get-started/hello/jupyter.html)
...
:::{.column width="70%"}
[![](figures/jupyter-notebook.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/jupyter-notebook.png"}
:::
:::
:::
...
[![](figures/pdf.png){width="85%"}](#){data-modal-type="image" data-modal-url="figures/pdf.png"}
:::
:::
:::
:::
...
:::{.column width="70%"}
:::{style="text-align: right;"}
[![](figures/pdf-jupyter.png){width="85%"}](#){data-modal-type="image" data-modal-url="figures/pdf-jupyter.png"}
:::
:::
:::
:::
...
- You can add the `.bib` file to your YAML header
...
:::{.columns}
:::{.column width="50%"}
[![](figures/scholar.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/scholar.png"}

[![](figures/citation.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/citation.png"}
...
:::{.column width="70%"}
[![](figures/bibtex.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/bibtex.png"}
:::
:::
:::
...
:::{.column width="50%"}
[![](figures/latex.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/latex.png"}
...
- Quarto has several advantages:
  - Over R Markdown: more flexibility, more languages, reveal.js support
...
:::{.column width="50%"}
[![](figures/slides.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/slides.png"}
:::
:::
:::
...
- It's a good idea to add `embed-resources: true` to the YAML header, so that all images and tables are included in the HTML file. More options here: <https://quarto.org/docs/reference/formats/presentations/revealjs.html>
...
- First, a simple example with text and images: <https://rawcdn.githack.com/danilofreire/datasci350/545939d5b14a7596fa6b726dc00ea6825bad321d/lectures/lecture-09/simple-slides.html>
- The code is available here: <https://raw.githubusercontent.com/danilofreire/datasci350/main/lectures/lecture-10/simple-slides.qmd>
...
- For example: <https://github.com/danilofreire/datasci350/blob/main/lectures/lecture-10/simple-slides.html>
...
:::{.column width="50%"}
[![](figures/website-structure.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/website-structure.png"}
:::
:::
:::
...
- Click the `Preview` button to see the website (first button on the right)
- You can add new pages, change the theme, and customise the website as you like
- Let's see how to do that!

:::{style="text-align: center;"}
[![](figures/vscode-create-project-render.png){width="80%"}](#){data-modal-type="image" data-modal-url="figures/vscode-create-project-render.png"}
:::
:::
...
- The file is available [here](https://github.com/danilofreire/datasci350/blob/gh-pages/_quarto.yml)
:::
...
website:
  ...
  navbar:
    ...
    tools:
      - icon: github
        href: https://github.com/danilofreire/datasci350
    left:
      - href: syllabus.qmd
        text: Syllabus
      ...
      - href: LICENSE.html
        text: " "
  page-footer: 
    left: "Copyright 2026, Danilo Freire. The content of this site is licensed under the [MIT License](LICENSE.qmd)." 
    right: 
      - icon: github
        href: https://github.com/danilofreire/datasci350
...
- [Website](https://danilofreire.github.io/datasci350/)
:::
:::
:::
...
Welcome to [DATASCI 350](https://github.com/danilofreire/datasci350)! [...]
...
- The full file is available [here](https://github.com/danilofreire/datasci350/blob/gh-pages/index.qmd)
:::
:::
:::
...
:::{style="margin-top: 30px; font-size: 23px;"}
[![](figures/website-qtm350.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/website-qtm350.png"}
:::

## Et voilà! 🎉

:::{style="margin-top: 30px; font-size: 23px;"}
[![](figures/voila.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/voila.png"}
:::

# And now you know what Quarto can do! 😎 {background-color="#2d4563"}
