...
format:
  clean-revealjs:
    self-contained: true
    footer: "[Comp. Literacy](https://danilofreire.github.io/datasci350/lectures/lecture-02/02-computational-literacy.html)"
transition: slide
...
`r fa('globe')` <https://danilofreire.github.io/datasci350>

`r fa('github')` <https://github.com/danilofreire/datasci350>
:::
:::

::: {.column}
- [Instructor]{.alert}: Danilo Freire
- [Lectures]{.alert}: Mondays and Wednesdays, 5:30-6:45 PM, Psy 230
- [Office hours]{.alert}: At any time, just send me an email in advance
- Please remember to [check the course repository regularly](https://github.com/danilofreire/datasci350) for updates and announcements `r emo::ji('winking_face')`
:::
::::
...
- Additional information will be made available on the [course repository](https://github.com/danilofreire/datasci350)
:::
:::
::::
:::::
...
:::{.callout-tip}
- Please check the [installation tutorials](https://danilofreire.github.io/datasci350/tutorials/tutorials.html) for more information
...
- Computers use binary because transistors are [easy to fabricate]{.alert} in silicon and can be densely packed on a chip (~200 billion transistors or more in modern processors, performing 4 billion calculations per second!)
...
- Why these numbers? They are [powers of 2]{.alert}!
...
- First, break the image down into a grid of colours, where each dot of colour has a distinct hue 
...
- 00000000 is no red, green, or blue and 11111111 is very red, green, or blue! 
- You can try different colours [here](https://www.w3schools.com/colors/colors_rgb.asp)
- But as you can see, the numbers can be quite long!
:::
...
:::: {.columns}
::: {.column width="60%"}
[![](figures/glyph.png){width="80%"}](#){data-modal-type="image" data-modal-url="figures/glyph.png"}
:::
...
the numbers 0 to 127 to characters. Therefore, one character is represented by
one byte (8 bits)
...
- Find all the Unicode characters here: <https://symbl.cc/en/unicode-table/>
  ...
  - "DATASCI 350" in Unicode: `\u0044\u0041\u0054\u0041\u0053\u0043\u0049\u0020\u0033\u0035\u0030`
...
- Please check the [installation tutorials](https://danilofreire.github.io/datasci350/tutorials/tutorials.html) for more information, and let me know if you have any questions `r emo::ji('smiley')`

:::{style="margin-top:30px;"}
:::

- [Assignment 01](https://github.com/danilofreire/datasci350/blob/main/assignments/01-assignment.ipynb) is already online. Please check it out! It is due next Wednesday 😉
:::  
::::
