...
All group members must contribute to the repository. It can be helpful to assign roles to each member to ensure that everyone contributes equally to the project. Each member's participation will be verified by the number of lines and commits in the repository, and anyone without contributions will receive a grade of 0 for the project. Although the repository will be hosted on someone's GitHub account, all members should have access to it.
