...
[![](figures/dimensions-of-scale.png){width="55%"}](#){data-modal-type="image" data-modal-url="figures/dimensions-of-scale.png"}
:::
...
:::{style="text-align: center;"}
[![](figures/prophet.png){width="65%"}](#){data-modal-type="image" data-modal-url="figures/prophet.png"}
:::
:::
...
:::{.column width="50%"}
:::{style="text-align: center;"}
[![](figures/docker.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/docker.png"}
:::
:::
:::
:::
